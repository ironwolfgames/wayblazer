This breakdown is formatted as a GitHub Issue, providing a junior developer with clear, tutorial-style instructions to complete **Sprint 7: Basic Crafting & Inventory (16 Hours)**. This sprint introduces the first step in the solution phase: converting raw resources into usable building materials via the **Basic Furnace**.
...
*Ready to begin Sprint 8: Advanced Refining (Composition).*
